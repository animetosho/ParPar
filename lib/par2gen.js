...
var MAX_BUFFER_SIZE = require('buffer').kMaxLength || (1024*1024*1024-1);
...
function PAR2Gen(fileInfo, sliceSize, opts) {
	...
	if(o.sliceSize > MAX_BUFFER_SIZE) throw new Error('Slice size exceeds maximum size supported by this version of Node.js of ' + MAX_BUFFER_SIZE + ' bytes');
