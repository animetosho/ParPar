...
function PAR2Gen(fileInfo, sliceSize, opts) {
	...
	if(this.totalSize / o.sliceSize > 32768) throw new Error('Too many input slices: ' + Math.ceil(this.totalSize / o.sliceSize) + ' exceeds maximum of 32768. Please consider increasing the slice size, or reducing the amount of input data');
