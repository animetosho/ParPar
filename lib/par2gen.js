...
function PAR2Gen(fileInfo, sliceSize, opts) {
	...
	var par = this.par2 = new Par2.PAR2(fileInfo, o.sliceSize, {method: gfInfo.id, threads: o.numThreads, batchSize: o.processBatchSize, stagingCount: stagingCount, hashBatchSize: o.hashBatchSize});
