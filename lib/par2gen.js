...
function PAR2Gen(fileInfo, sliceSize, opts) {
	...
	o.outputFileMaxSlices = Math.round(calcNumRecoverySlices(o.outputFileMaxSlices, o.sliceSize, this.totalSize, fileInfo));
	o.outputFileMaxSlices = Math.max(o.outputFileMaxSlices, 1);
	if(o.outputFirstFileSlices) {
		o.outputFirstFileSlices = Math.round(calcNumRecoverySlices(o.outputFirstFileSlices, o.sliceSize, this.totalSize, fileInfo));
