...
var AlignedBuffer; // note, this aligns to alignment, but doesn't align to stride
if(gf.AlignedBuffer) {
...
var GF_METHODS = [
	'' /*default*/, 'lh_lookup',
	'shuffle-neon', 'shuffle-sse', 'shuffle-avx', 'shuffle-avx2', 'shuffle-avx512',
	'xor-sse', 'xorjit-sse', 'xorjit-avx2', 'xorjit-avx512',
	'affine-gfni', 'affine-avx512'
];
