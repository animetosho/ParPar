...
void gf16pmul_sve2(void *HEDLEY_RESTRICT dst, const void* src1, const void* src2, size_t len) {
	...
	for(intptr_t ptr = -(intptr_t)len; ptr; ptr += svcntb()*2) {
		...
		svuint8_t low1 = svpmullb_pair_u8(svget2_u8(data1, 0), svget2_u8(data2, 0));
		svuint8_t low2 = svpmullt_pair_u8(svget2_u8(data1, 0), svget2_u8(data2, 0));
		svuint8_t dataMid1 = NOMASK(sveor_u8, svget2_u8(data1, 0), svget2_u8(data1, 1));
		svuint8_t dataMid2 = NOMASK(sveor_u8, svget2_u8(data2, 0), svget2_u8(data2, 1));
		svuint8_t mid1 = svpmullb_pair_u8(dataMid1, dataMid2);
		svuint8_t mid2 = svpmullt_pair_u8(dataMid1, dataMid2);
		svuint8_t high1 = svpmullb_pair_u8(svget2_u8(data1, 1), svget2_u8(data2, 1));
		svuint8_t high2 = svpmullt_pair_u8(svget2_u8(data1, 1), svget2_u8(data2, 1));
