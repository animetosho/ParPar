...
#define ROUND_F(A1, B1, C1, D1, A2, B2, C2, D2, NEXT_IN1, NEXT_IN2, K, R) \
	"leal " STR(K) "(%k[" STR(A1) "], %k[TMP1]), %k[" STR(A1) "]\n" \
	"leal " STR(K) "(%k[" STR(A2) "], %k[TMP2]), %k[" STR(A2) "]\n" \
	...
	"movl " NEXT_IN1 ", %k[TMP1]\n" \
	"movl " NEXT_IN2 ", %k[TMP2]\n" \
	"roll $" STR(R) ", %k[" STR(A1) "]\n" \
	"roll $" STR(R) ", %k[" STR(A2) "]\n" \
...
#define ASM_PARAMS(i0, i1, i2, i3) \
	[A1]"+r"(A1), [B1]"+r"(B1), [C1]"+r"(C1), [D1]"+r"(D1), \
	[A2]"+r"(A2), [B2]"+r"(B2), [C2]"+r"(C2), [D2]"+r"(D2), \
	[TMP1]"+r"(tmp1), [TMP2]"+r"(tmp2) \
: [i0_0]"m"(_data[0][i0]), [i0_1]"m"(_data[0][i1]), [i0_2]"m"(_data[0][i2]), [i0_3]"m"(_data[0][i3]), \
  [i1_0]"m"(_data[1][i0]), [i1_1]"m"(_data[1][i1]), [i1_2]"m"(_data[1][i2]), [i1_3]"m"(_data[1][i3]) \
:
...
#define RF4(i0, i1, i2, i3, k0, k1, k2, k3) asm( \
	...
	ROUND_F(C1, D1, A1, B1, C2, D2, A2, B2, "%[i0_2]", "%[i1_2]", k2, 17) \
	ROUND_F(B1, C1, D1, A1, B2, C2, D2, A2, "%[i0_3]", "%[i1_3]", k3, 22) \
: ASM_PARAMS(i0, i1, i2, i3));
...
#define RG4(i0, i1, i2, i3, k0, k1, k2, k3) asm( \
	...
	ROUND_G(C1, D1, A1, B1, C2, D2, A2, B2, "%[i0_2]", "%[i1_2]", k2, 14) \
	ROUND_G(B1, C1, D1, A1, B2, C2, D2, A2, "%[i0_3]", "%[i1_3]", k3, 20) \
: ASM_PARAMS(i0, i1, i2, i3));
...
#define RH4(i0, i1, i2, i3, k0, k1, k2, k3) asm( \
	...
	ROUND_H(C1, D1, A1, B1, C2, D2, A2, B2, "%[i0_2]", "%[i1_2]", k2, 16) \
	ROUND_H(B1, C1, D1, A1, B2, C2, D2, A2, "%[i0_3]", "%[i1_3]", k3, 23) \
: ASM_PARAMS(i0, i1, i2, i3));
...
#define RI4(i0, i1, i2, i3, k0, k1, k2, k3) asm( \
	...
	ROUND_I(C1, D1, A1, B1, C2, D2, A2, B2, "%[i0_2]", "%[i1_2]", k2, 15) \
	ROUND_I(B1, C1, D1, A1, B2, C2, D2, A2, "%[i0_3]", "%[i1_3]", k3, 21) \
: ASM_PARAMS(i0, i1, i2, i3));
	...
	asm(
		...
		ROUND_I(C1, D1, A1, B1, C2, D2, A2, B2, "%[i0_2]", "%[i1_2]", 0x2ad7d2bb, 15)
