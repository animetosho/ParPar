...
static inline uint8_t* xor_write_jit_avx(struct gf16_xor_scratch *HEDLEY_RESTRICT scratch, uint16_t val, int xor) {
	uint_fast32_t i, bit;
...
void gf16_xor_jit_mul_avx2(const void *HEDLEY_RESTRICT scratch, void *HEDLEY_RESTRICT dst, const void *HEDLEY_RESTRICT src, size_t len, uint16_t coefficient) {
#if defined(__AVX2__) && defined(PLATFORM_AMD64)
	...
	gf16_xor256_jit_stub(
		...
		(intptr_t)dst - 384,
		xor_write_jit_avx(info, coefficient, 0)
	);
...
void gf16_xor_jit_muladd_avx2(const void *HEDLEY_RESTRICT scratch, void *HEDLEY_RESTRICT dst, const void *HEDLEY_RESTRICT src, size_t len, uint16_t coefficient) {
#if defined(__AVX2__) && defined(PLATFORM_AMD64)
	struct gf16_xor_scratch *HEDLEY_RESTRICT info = (struct gf16_xor_scratch *HEDLEY_RESTRICT)scratch;
	...
	gf16_xor256_jit_stub(
		...
		(intptr_t)dst + len + 128,
		(intptr_t)dst - 384,
		xor_write_jit_avx(info, coefficient, 1)
	);
